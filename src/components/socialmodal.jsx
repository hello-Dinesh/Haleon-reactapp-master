...
const SocialModal = ({ userData, onClose }) => {
  const handleEmailButtonClick = () => {
    // Open user's default email client with a new email draft
    window.location.href = `mailto:${userData.email}`;
  };

  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-8 rounded-md max-w-xl shadow-lg">

      <h2 className="text-2xl font-bold mb-4">Socials:</h2>

      <ul class="ml-3">
        <li class="my-4"><a href="#" aria-label="GITHUB" target="_blank" rel="noopener"
        ...
        <li class="my-4"><a href="#" aria-label="INSTAGRAM" target="_blank" rel="noopener"
                class="w-min flex items-center hover:underline bg-white px-1 py-1 rounded-md text-black transition hover:translate-x-2 hover:no-underline"><svg
        ...
        <li class="my-4"><a href="#" aria-label="FACEBOOK" target="_blank" rel="noopener"
                class="w-min flex items-center hover:underline bg-white px-1 py-1 rounded-md text-black transition hover:translate-x-2 hover:no-underline"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20">
                    <path
        ...
        <button
          ...
          className="bg-blue-500 text-white hover:bg-blue-400 py-2 px-6 rounded-full text-lg font-semibold mr-4 mt-4"
        >
          Email Me
        </button>
        <button onClick={onClose} className="bg-red-500 text-white hover:bg-red-400 py-2 px-6 rounded-full text-lg font-semibold mt-4">
          Close
        </button>
      </div>
    </div>
