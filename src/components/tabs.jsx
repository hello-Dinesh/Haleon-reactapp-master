...
const Tabs = ({ userData }) => {
  const tabsData = [
    ...
    { id: 2, title: 'Posts', content: 'Posts Content' },
    { id: 3, title: 'Videos', content: 'Videos Content' },
    { id: 4, title: 'Comments', content: 'Comments Content' },
    { id: 5, title: 'Settings', content: 'Settings Content' },
    { id: 6, title: 'Logout', content: 'Logout Content' },
  ];
